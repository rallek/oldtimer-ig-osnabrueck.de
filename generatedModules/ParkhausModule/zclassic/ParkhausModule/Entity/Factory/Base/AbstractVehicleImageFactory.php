 ...
 *
 * This is the base factory class for vehicle image entities.
 */
abstract class AbstractVehicleImageFactory
{
    /**
     * @var String Full qualified class name to be used for vehicle images.
     */
    protected $className;
    ...
    /**
     * VehicleImageFactory constructor.
     *
     * @param ObjectManager $objectManager The object manager to be used for determining the repository
     * @param String        $className     Full qualified class name to be used for vehicle images
     */
