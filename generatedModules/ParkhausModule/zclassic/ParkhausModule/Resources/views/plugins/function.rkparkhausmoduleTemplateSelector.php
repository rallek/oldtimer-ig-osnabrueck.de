...
/**
 * The rkparkhausmoduleTemplateSelector plugin provides items for a dropdown selector.
 *
 ...
 */
function smarty_function_rkparkhausmoduleTemplateSelector($params, $view)
{
    $result = [];
