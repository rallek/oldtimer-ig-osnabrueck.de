...
use RK\ParkHausModule\Listener\Base\AbstractKernelListener;
...
class KernelListener extends AbstractKernelListener
{
    ...
    public function onRequest(GetResponseEvent $event)
    {
        ...
        // $testMessage = 'Hello from park haus app';
        // $event->getRequest()->attributes->set('RKParkHausModule_test', $testMessage);
    ...
    public function onResponse(FilterResponseEvent $event)
    {
        ...
        // $testMessage = $event->getRequest()->attributes->get('RKParkHausModule_test');
        // now $testMessage should be: 'Hello from park haus app'
    ...
    public function onException(GetResponseForExceptionEvent $event)
    {
        ...
        //     || $exception instanceof MySpecialExceptionInterface) {
            ...
            // $message = sprintf(
            //     'park haus App Error says: %s with code: %s',
