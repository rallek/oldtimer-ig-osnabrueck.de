...
namespace RK\ParkhausModule\Block\Base;
...
abstract class AbstractItemListBlock extends AbstractBlockHandler
{
    ...
    public function display(array $properties)
    {
        ...
        if (!$this->hasPermission('RKParkhausModule:ItemListBlock:', "$properties[title]::", ACCESS_OVERVIEW)) {
            return false;
        }
        ...
        if (empty($properties['title'])) {
            $properties['title'] = $this->__('RKParkhausModule items');
        }
    ...
    protected function getDisplayTemplate(array $properties)
    {
        ...
        $template = '@RKParkhausModule/' . $template;
    ...
    {
        return 'RK\ParkhausModule\Block\Form\Type\ItemListBlockType';
    }
    ...
    {
        return '@RKParkhausModule/Block/itemlist_modify.html.twig';
    }
