...
abstract class AbstractParkHausModuleInstaller extends AbstractExtensionInstaller
{
    ...
    public function install()
    {
        ...
        try {
            ...
            $uploadHelper = new \RK\ParkHausModule\Helper\UploadHelper($container->get('translator.default'), $container->get('session'), $container->get('logger'), $container->get('zikula_users_module.current_user'), $container->get('zikula_extensions_module.api.variable'), $container->getParameter('datadir'));
        ...
        $this->setVar('linkOwnVehiclesOnAccountPage', true);
        $this->setVar('vehicleImageEntriesPerPage', 10);
        $this->setVar('linkOwnVehicleImagesOnAccountPage', true);
        ...
        $this->setVar('thumbnailModeVehicleTitleImage',  'inset' );
        ...
        $this->setVar('thumbnailModeVehicleVehicleImage',  'inset' );
        ...
        $this->setVar('thumbnailModeVehicleManufacturerImage',  'inset' );
        ...
        $this->setVar('thumbnailModeVehicleImageVehicleImage',  'inset' );
