...
abstract class AbstractEditHandler extends EditHandler
{
    ...
    protected function getRedirectCodes()
    {
        ...
        // user index page of vehicle area
        $codes[] = 'userIndex';
        // admin index page of vehicle area
        $codes[] = 'adminIndex';
    ...
    public function applyAction(array $args = [])
    {
        ...
        try {
            ...
            $logArgs = ['app' => 'RKParkHausModule', 'user' => $this->currentUserApi->get('uname'), 'entity' => 'vehicle', 'id' => $entity->createCompositeIdentifier(), 'errorMessage' => $e->getMessage()];
