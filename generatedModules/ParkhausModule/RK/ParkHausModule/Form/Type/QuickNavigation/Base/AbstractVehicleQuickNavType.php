...
/**
 * Vehicle quick navigation form type base class.
 */
abstract class AbstractVehicleQuickNavType extends AbstractType
{
    use TranslatorTrait;
    ...
    /**
     * VehicleQuickNavType constructor.
     *
    ...
    {
        $listEntries = $this->listHelper->getEntries('vehicle', 'workflowState');
        $choices = [];
        $choiceAttributes = [];
    ...
    {
        return 'rkparkhausmodule_vehiclequicknav';
    }
}
