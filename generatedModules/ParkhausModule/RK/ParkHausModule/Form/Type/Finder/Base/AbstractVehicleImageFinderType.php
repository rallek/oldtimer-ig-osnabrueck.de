...
/**
 * Vehicle image finder form type base class.
 */
abstract class AbstractVehicleImageFinderType extends AbstractType
{
    use TranslatorTrait;

    /**
     * VehicleImageFinderType constructor.
     *
    ...
    public function addPasteAsField(FormBuilderInterface $builder, array $options)
    {
        $builder->add('pasteAs', 'Symfony\Component\Form\Extension\Core\Type\ChoiceType', [
            ...
            'empty_data' => 1,
            'choices' => [
                $this->__('Link to the vehicle image') => 1,
                $this->__('ID of vehicle image') => 2,
                $this->__('Link to the image') => 6,
                $this->__('Image') => 7,
                $this->__('Image with link to the vehicle image') => 8
            ],
    ...
    {
        return 'rkparkhausmodule_vehicleimagefinder';
    }
