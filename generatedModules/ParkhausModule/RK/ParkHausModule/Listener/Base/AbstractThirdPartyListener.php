...
abstract class AbstractThirdPartyListener implements EventSubscriberInterface
{
    ...
    public function contentGetTypes(\Zikula_Event $event)
    {
        ...
        $types->add('RKParkHausModule_ContentType_Item');
        
        // plugin for showing a list of multiple items
        $types->add('RKParkHausModule_ContentType_ItemList');
    }
     ...
     * RKParkHausModule will use this to add a javascript helper to add custom items.
     *
     * @param \Zikula_Event $event The event instance
     */
    public function getEditorHelpers(\Zikula_Event $event)
    {
        ...
        $helpers->add(
            [
                ...
                'type'   => 'javascript',
                'path'   => 'modules/RK/ParkHausModule/Resources/public/js/RKParkHausModule.Finder.js'
            ]
        );
    }
    ...
    public function getTinyMcePlugins(\Zikula_Event $event)
    {
        ...
        $plugins->add(
            [
                'name' => 'rkparkhausmodule',
                'path' => 'modules/RK/ParkHausModule/Resources/docs/scribite/plugins/TinyMce/vendor/tinymce/plugins/rkparkhausmodule/plugin.js'
            ]
        );
    }
    ...
    public function getCKEditorPlugins(\Zikula_Event $event)
    {
        ...
        $plugins->add(
            [
                'name' => 'rkparkhausmodule',
                'path' => 'modules/RK/ParkHausModule/Resources/docs/scribite/plugins/CKEditor/vendor/ckeditor/plugins/rkparkhausmodule/',
                'file' => 'plugin.js',
                'img'  => 'ed_rkparkhausmodule.gif'
            ]
        );
    }
}
