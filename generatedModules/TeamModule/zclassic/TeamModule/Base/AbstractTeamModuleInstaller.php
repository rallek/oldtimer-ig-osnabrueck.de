...
abstract class AbstractTeamModuleInstaller extends AbstractExtensionInstaller
{
    ...
    public function install()
    {
        ...
        try {
            ...
            $controllerHelper = new \RK\TeamModule\Helper\ControllerHelper($container, $container->get('translator.default'), $container->get('session'), $container->get('logger'));
        ...
        $this->setVar('thumbnailModePerson',  'inset' );
    ...
    */
    ...
    public function uninstall()
    {
        ...
        if (false === $result) {
            $this->addFlash('error', $this->__f('An error was encountered while removing stored object workflows for the %s extension.', ['%s' => 'RKTeamModule']));
