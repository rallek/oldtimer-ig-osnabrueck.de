...
abstract class AbstractLinkContainer implements LinkContainerInterface
{
    ...
    public function getLinks($type = LinkContainerInterface::TYPE_ADMIN)
    {
        ...
        if (LinkContainerInterface::TYPE_ACCOUNT == $type) {
            $useAccountPage = $this->variableApi->get('RKTeamModule', 'useAccountPage', true);
            ...
            if ($this->permissionApi->hasPermission($this->getBundleName() . '::', '::', ACCESS_ADMIN)) {
                $links[] = [
                    'url' => $this->router->generate('rkteammodule_admin_index'),
        ...
        if (LinkContainerInterface::TYPE_ADMIN == $type) {
            if ($this->permissionApi->hasPermission($this->getBundleName() . '::', '::', ACCESS_READ)) {
                $links[] = [
                    'url' => $this->router->generate('rkteammodule_user_index'),
            ...
            if (in_array('person', $allowedObjectTypes)
                ...
                $links[] = [
                    'url' => $this->router->generate('rkteammodule_person_adminview'),
        ...
        if (LinkContainerInterface::TYPE_USER == $type) {
            ...
            if (in_array('person', $allowedObjectTypes)
                && $this->permissionApi->hasPermission($this->getBundleName() . ':Person:', '::', $permLevel)) {
                $links[] = [
                    'url' => $this->router->generate('rkteammodule_person_view'),
                     'text' => $this->__('Persons'),
                     'title' => $this->__('Person list')
                 ];
            }
