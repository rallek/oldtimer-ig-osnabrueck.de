...
abstract class AbstractUserListener implements EventSubscriberInterface
{
    ...
    public function delete(GenericEvent $event)
    {
        ...
        $repo = $entityManager->getRepository('RK\TeamModule\Entity\PersonEntity');
        ...
        $repo->updateUserField('registeredUser', $uid, 1, $translator, $logger, $currentUserApi);
        
        $logArgs = ['app' => 'RKTeamModule', 'user' => $serviceManager->get('zikula_users_module.current_user')->get('uname'), 'entities' => 'persons'];
