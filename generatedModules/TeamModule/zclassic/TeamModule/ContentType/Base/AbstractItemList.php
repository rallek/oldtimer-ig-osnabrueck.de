...
abstract class AbstractItemList extends \Content_AbstractContentType
{
    ...
    public function getTitle()
    {
        ...
        return $serviceManager->get('translator.default')->__('RKTeamModule list view');
    }
    ...
    public function getDescription()
    {
        ...
        return $serviceManager->get('translator.default')->__('Display list of RKTeamModule objects.');
    }
    ...
    public function display()
    {
        ...
        $serviceManager = ServiceUtil::getManager();
        $repository = $serviceManager->get('rk_team_module.' . $this->objectType . '_factory')->getRepository();
        ...
        $imageHelper = $serviceManager->get('rk_team_module.image_helper');
        ...
        $output = $serviceManager->get('twig')->render('@RKTeamModule/' . $template, $templateParameters);
    ...
    protected function getSortParam($repository)
    {
        ...
        if ($this->sorting == 'newest') {
            $selectionHelper = ServiceUtil::get('rk_team_module.selection_helper');
    ...
    public function startEditing()
    {
        ...
        array_push($this->view->plugins_dir, 'modules/RKTeamModule/Resources/views//plugins');
    }
