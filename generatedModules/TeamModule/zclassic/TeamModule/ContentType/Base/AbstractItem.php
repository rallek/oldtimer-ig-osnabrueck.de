...
abstract class AbstractItem extends \Content_AbstractContentType
{
    ...
    public function getTitle()
    {
        ...
        return $serviceManager->get('translator.default')->__('RKTeamModule detail view');
    }
    ...
    public function getDescription()
    {
        ...
        return $serviceManager->get('translator.default')->__('Display or link a single RKTeamModule object.');
    }
    ...
    public function display()
    {
        if (null !== $this->id && !empty($this->displayMode)) {
            return ModUtil::func('RKTeamModule', 'external', 'display', $this->getDisplayArguments());
        }
