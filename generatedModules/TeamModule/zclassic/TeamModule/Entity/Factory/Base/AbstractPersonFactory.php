 ...
 *
 * This is the base factory class for person entities.
 */
abstract class AbstractPersonFactory
{
    /**
     * @var String Full qualified class name to be used for persons.
     */
    protected $className;
     ...
     * @param String        $className Full qualified class name to be used for persons
     */
