...
use RK\TeamModule\UploadHandler;
...
abstract class AbstractUploadFileTransformer implements DataTransformerInterface
{
    ...
    public function __construct(UploadType $formType, $fieldName)
    {
        ...
        $this->controllerHelper = ServiceUtil::get('rk_team_module.controller_helper');
        $this->uploadHandler = ServiceUtil::get('rk_team_module.upload_handler');
