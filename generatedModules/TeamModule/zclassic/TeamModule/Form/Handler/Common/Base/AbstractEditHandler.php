...
abstract class AbstractEditHandler
{
    ...
    public function processForm(array $templateParameters)
    {
        ...
        if (false === $actions || !is_array($actions)) {
            ...
            $logArgs = ['app' => 'RKTeamModule', 'user' => $this->container->get('zikula_users_module.current_user')->get('uname'), 'entity' => $this->objectType, 'id' => $entity->createCompositeIdentifier()];
    ...
    protected function initEntityForCreation()
    {
        ...
        if (is_null($entity)) {
            $factory = $this->container->get('rk_team_module.' . $this->objectType . '_factory');
    ...
    public function handleCommand($args = [])
    {
        ...
        if ($entity->supportsHookSubscribers() && $action != 'cancel') {
            $hookHelper = $this->container->get('rk_team_module.hook_helper');
    ...
    protected function addDefaultMessage($args, $success = false)
    {
        ...
        $logger = $this->container->get('logger');
        $logArgs = ['app' => 'RKTeamModule', 'user' => $this->container->get('zikula_users_module.current_user')->get('uname'), 'entity' => $this->objectType, 'id' => $this->entityRef->createCompositeIdentifier()];
        if (true === $success) {
