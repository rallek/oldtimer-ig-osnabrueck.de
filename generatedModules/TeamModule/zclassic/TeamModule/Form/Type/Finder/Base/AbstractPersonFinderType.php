...
abstract class AbstractPersonFinderType extends AbstractType
{
    ...
    public function addPasteAsField(FormBuilderInterface $builder, array $options)
    {
        $builder->add('pasteas', 'Symfony\Component\Form\Extension\Core\Type\ChoiceType', [
            ...
            'empty_data' => 1,
            'choices' => [
                $this->__('Link to the person') => 1,
                $this->__('ID of person') => 2
            ],
        ...
        $builder
            ->add('sort', 'Symfony\Component\Form\Extension\Core\Type\ChoiceType', [
                ...
                'choices' => [
                    ...
                    $this->__('Team member image') => 'teamMemberImage',
                    $this->__('Team member function') => 'teamMemberFunction',
                    $this->__('Team member description') => 'teamMemberDescription',
                    $this->__('Phone number') => 'phoneNumber',
                    $this->__('Mobile number') => 'mobileNumber',
                    $this->__('Person email address') => 'personEmailAddress',
                    $this->__('Person address') => 'personAddress',
                    $this->__('Registered user') => 'registeredUser',
                    $this->__('Filter') => 'filter',
