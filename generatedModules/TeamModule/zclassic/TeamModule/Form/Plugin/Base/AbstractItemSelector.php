...
class AbstractItemSelector extends Zikula_Form_Plugin_TextInput
{
    ...
    public function render(Zikula_Form_View $view)
    {
        ...
        if ($firstTime) {
            ...
            PageUtil::addVar('javascript', '@RKTeamModule/Resources/public/js/RKTeamModule.Finder.js');
            PageUtil::addVar('stylesheet', '@RKTeamModule/Resources/public/css/style.css');
        }
        $firstTime = false;
    ...
    {
        parent::decode($view);
        $this->objectType = FormUtil::getPassedValue('RKTeamModule_objecttype', 'person', 'POST');
        $this->selectedItemId = $this->text;
    }
}
