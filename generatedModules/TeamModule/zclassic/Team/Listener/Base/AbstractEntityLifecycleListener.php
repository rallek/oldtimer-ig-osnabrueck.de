...
abstract class AbstractEntityLifecycleListener implements EventSubscriber
{
    ...
    public function preRemove(LifecycleEventArgs $args)
    {
        ...
        $dispatcher->dispatch(constant('\\RK\\TeamModule\\TeamEvents::' . strtoupper($entity->get_objectType()) . '_PRE_REMOVE'), $event);
    ...
    public function postRemove(LifecycleEventArgs $args)
    {
        ...
        $uploadManager = $serviceManager->get('rk_team_module.upload_handler');
        ...
        $logArgs = ['app' => 'RKTeamModule', 'user' => $serviceManager->get('zikula_users_module.current_user')->get('uname'), 'entity' => $objectType, 'id' => $objectId];
        ...
        $event = new $filterEventClass($entity);
        $dispatcher->dispatch(constant('\\RK\\TeamModule\\TeamEvents::' . strtoupper($objectType) . '_POST_REMOVE'), $event);
    }
    ...
    public function prePersist(LifecycleEventArgs $args)
    {
        ...
        $filterEventClass = '\\RK\\TeamModule\\Event\\Filter' . ucfirst($entity->get_objectType()) . 'Event';
        $event = new $filterEventClass($entity);
        $dispatcher->dispatch(constant('\\RK\\TeamModule\\TeamEvents::' . strtoupper($entity->get_objectType()) . '_PRE_PERSIST'), $event);
        if ($event->isPropagationStopped()) {
            return false;
        }
    }
    ...
    public function postPersist(LifecycleEventArgs $args)
    {
        ...
        $objectId = $entity->createCompositeIdentifier();
        $logger = $serviceManager->get('logger');
        $logArgs = ['app' => 'RKTeamModule', 'user' => $serviceManager->get('zikula_users_module.current_user')->get('uname'), 'entity' => $entity->get_objectType(), 'id' => $objectId];
        ...
        $filterEventClass = '\\RK\\TeamModule\\Event\\Filter' . ucfirst($entity->get_objectType()) . 'Event';
        $event = new $filterEventClass($entity);
        $dispatcher->dispatch(constant('\\RK\\TeamModule\\TeamEvents::' . strtoupper($entity->get_objectType()) . '_POST_PERSIST'), $event);
    }
    ...
    public function preUpdate(PreUpdateEventArgs $args)
    {
        ...
        $filterEventClass = '\\RK\\TeamModule\\Event\\Filter' . ucfirst($entity->get_objectType()) . 'Event';
        $event = new $filterEventClass($entity);
        $dispatcher->dispatch(constant('\\RK\\TeamModule\\TeamEvents::' . strtoupper($entity->get_objectType()) . '_PRE_UPDATE'), $event);
        if ($event->isPropagationStopped()) {
            return false;
        }
    }
    ...
    public function postUpdate(LifecycleEventArgs $args)
    {
        ...
        $filterEventClass = '\\RK\\TeamModule\\Event\\Filter' . ucfirst($entity->get_objectType()) . 'Event';
        $event = new $filterEventClass($entity);
        $dispatcher->dispatch(constant('\\RK\\TeamModule\\TeamEvents::' . strtoupper($entity->get_objectType()) . '_POST_UPDATE'), $event);
    }
    ...
    public function postLoad(LifecycleEventArgs $args)
    {
        ...
        $objectType = $entity->get_objectType();
        $controllerHelper = ServiceUtil::get('rk_team_module.controller_helper');
        ...
        $filterEventClass = '\\RK\\TeamModule\\Event\\Filter' . ucfirst($entity->get_objectType()) . 'Event';
        $event = new $filterEventClass($entity);
        $dispatcher->dispatch(constant('\\RK\\TeamModule\\TeamEvents::' . strtoupper($entity->get_objectType()) . '_POST_LOAD'), $event);
    }
