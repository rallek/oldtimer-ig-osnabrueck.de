...
abstract class AbstractItemList extends \Content_AbstractContentType
{
    ...
    public function getTitle()
    {
        ...
        return $serviceManager->get('translator.default')->__('RKWebsiteHelperModule list view');
    }
    ...
    public function getDescription()
    {
        ...
        return $serviceManager->get('translator.default')->__('Display list of RKWebsiteHelperModule objects.');
    }
    ...
    {
        $dom = ZLanguage::getModuleDomain('RKWebsiteHelperModule');
    
        $serviceManager = ServiceUtil::getManager();
        $repository = $serviceManager->get('rk_websitehelper_module.' . $this->objectType . '_factory')->getRepository();
        ...
        $imageHelper = $serviceManager->get('rk_websitehelper_module.image_helper');
        ...
        $output = $serviceManager->get('twig')->render('@RKWebsiteHelperModule/' . $template, $templateParameters);
    ...
    protected function getSortParam($repository)
    {
        ...
        if ($this->sorting == 'newest') {
            $selectionHelper = ServiceUtil::get('rk_websitehelper_module.selection_helper');
