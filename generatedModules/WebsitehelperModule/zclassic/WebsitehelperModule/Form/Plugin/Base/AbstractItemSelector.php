...
class AbstractItemSelector extends Zikula_Form_Plugin_TextInput
{
    ...
    public function render(Zikula_Form_View $view)
    {
        ...
        if ($firstTime) {
            ...
            PageUtil::addVar('javascript', '@RKWebsiteHelperModule/Resources/public/js/RKWebsiteHelperModule.Finder.js');
    ...
    {
        parent::decode($view);
        $this->objectType = FormUtil::getPassedValue('RKWebsiteHelperModule_objecttype', 'linker', 'POST');
        $this->selectedItemId = $this->text;
    }
}
