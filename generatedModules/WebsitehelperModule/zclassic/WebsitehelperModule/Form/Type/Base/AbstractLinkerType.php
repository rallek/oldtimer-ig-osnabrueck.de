...
use RK\WebsiteHelperModule\Entity\Factory\LinkerFactory;
...
abstract class AbstractLinkerType extends AbstractType
{
     ...
     * @param LinkerFactory        $entityFactory Entity factory service instance
     * @param ListEntriesHelper   $listHelper    ListEntriesHelper service instance
     */
    public function __construct(TranslatorInterface $translator, LinkerFactory $entityFactory, ListEntriesHelper $listHelper)
    {
    ...
    {
        $builder->add('linkerImage', 'RK\WebsiteHelperModule\Form\Type\Field\UploadType', [
        ...
        $builder->add('sorting', 'Symfony\Component\Form\Extension\Core\Type\IntegerType', [
            ...
            'attr' => [
                ...
                'title' => $this->__('Enter the sorting of the linker. Only digits are allowed.')
            ],'required' => true,
            'max_length' => 11,
            'scale' => 0
        ]);
    ...
    {
        return 'rkwebsitehelpermodule_linker';
    }
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver
            ->setDefaults([
                ...
                'data_class' => 'RK\WebsiteHelperModule\Entity\LinkerEntity',
