...
use RK\WebsiteHelperModule\Form\DataTransformer\UploadFileTransformer;
...
abstract class AbstractUploadType extends AbstractType
{
    ...
    public function buildView(FormView $view, FormInterface $form, array $options)
    {
        ...
        if (true === $fileMeta['isImage']) {
            $imageHelper = ServiceUtil::get('rk_websitehelper_module.image_helper');
    ...
    {
        return 'rkwebsitehelpermodule_field_upload';
    }
}
