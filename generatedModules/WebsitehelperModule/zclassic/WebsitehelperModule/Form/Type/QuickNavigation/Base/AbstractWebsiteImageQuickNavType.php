...
/**
 * Website image quick navigation form type base class.
 */
abstract class AbstractWebsiteImageQuickNavType extends AbstractType
{
    use TranslatorTrait;
    ...
    /**
     * WebsiteImageQuickNavType constructor.
     *
    ...
    {
        $listEntries = $this->listHelper->getEntries('websiteImage', 'workflowState');
        $choices = [];
        $choiceAttributes = [];
    ...
    {
        return 'rkwebsitehelpermodule_websiteimagequicknav';
    }
}
