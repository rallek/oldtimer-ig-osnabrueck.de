...
namespace RK\WebsitehelperModule\Twig\Base;
...
use RK\WebsitehelperModule\Helper\ViewHelper;
use RK\WebsitehelperModule\Helper\WorkflowHelper;
...
abstract class AbstractTwigExtension extends \Twig_Extension
{
    ...
    {
        return [
            new \Twig_SimpleFunction('rkwebsitehelpermodule_objectTypeSelector', [$this, 'getObjectTypeSelector']),
            new \Twig_SimpleFunction('rkwebsitehelpermodule_templateSelector', [$this, 'getTemplateSelector']),
            new \Twig_SimpleFunction('rkwebsitehelpermodule_userVar', [$this, 'getUserVar']),
            new \Twig_SimpleFunction('rkwebsitehelpermodule_userAvatar', [$this, 'getUserAvatar'], ['is_safe' => ['html']])
        ];
    }
    ...
    {
        return [
            new \Twig_SimpleFilter('rkwebsitehelpermodule_fileSize', [$this, 'getFileSize'], ['is_safe' => ['html']]),
            new \Twig_SimpleFilter('rkwebsitehelpermodule_listEntry', [$this, 'getListEntry']),
            new \Twig_SimpleFilter('rkwebsitehelpermodule_objectState', [$this, 'getObjectState'], ['is_safe' => ['html']])
        ];
    }
    
    /**
     * The rkwebsitehelpermodule_objectState filter displays the name of a given object's workflow state.
     * Examples:
     *    {{ item.workflowState|rkwebsitehelpermodule_objectState }}        {# with visual feedback #}
     *    {{ item.workflowState|rkwebsitehelpermodule_objectState(false) }} {# no ui feedback #}
     *
    ...
    /**
     * The rkwebsitehelpermodule_fileSize filter displays the size of a given file in a readable way.
     * Example:
     *     {{ 12345|rkwebsitehelpermodule_fileSize }}
     *
    ...
    /**
     * The rkwebsitehelpermodule_listEntry filter displays the name
     * or names for a given list item.
     * Example:
     *     {{ entity.listField|rkwebsitehelpermodule_listEntry('entityName', 'fieldName') }}
     *
    ...
    /**
     * The rkwebsitehelpermodule_objectTypeSelector function provides items for a dropdown selector.
     *
    ...
    /**
     * The rkwebsitehelpermodule_templateSelector function provides items for a dropdown selector.
     *
     * @return string The output of the plugin
     */
    ...
    public function getUserAvatar($uid, $width = 0, $height = 0, $size = 0, $rating = '')
    {
        ...
        $view = \Zikula_View::getInstance('RKWebsitehelperModule');
