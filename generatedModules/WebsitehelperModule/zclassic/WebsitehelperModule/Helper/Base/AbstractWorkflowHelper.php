...
abstract class AbstractWorkflowHelper
{
    ...
    {
        $this->name = 'RKWebsiteHelperModule';
    ...
    public function getActionsForObject($entity)
    {
        ...
        $listHelper = $this->container->get('rk_websitehelper_module.listentries_helper');
    ...
    public function executeAction($entity, $actionId = '', $recursive = false)
    {
        ...
        $result = Zikula_Workflow_Util::executeAction($schemaName, $entity, $actionId, $objectType, 'RKWebsiteHelperModule', $idColumn);
    ...
    public function normaliseWorkflowData(&$entity)
    {
        ...
        if (!is_object($workflow)) {
            $workflow['module'] = 'RKWebsiteHelperModule';
    ...
    {
        $repository = $this->container->get('rk_websitehelper_module.' . $objectType . '_factory')->getRepository();
