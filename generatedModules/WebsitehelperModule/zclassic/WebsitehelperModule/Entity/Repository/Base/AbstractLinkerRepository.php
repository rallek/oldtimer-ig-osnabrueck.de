...
abstract class AbstractLinkerRepository extends SortableRepository
{
    ...
    public function truncateTable(LoggerInterface $logger)
    {
        ...
        $qb->delete('RK\WebsiteHelperModule\Entity\LinkerEntity', 'tbl');
        $query = $qb->getQuery();
    
        $query->execute();
    
        $logArgs = ['app' => 'RKWebsiteHelperModule', 'entity' => 'linker'];
    ...
    public function updateCreator($userId, $newUserId, TranslatorInterface $translator, LoggerInterface $logger, CurrentUserApi $currentUserApi)
    {
        ...
        $qb = $this->getEntityManager()->createQueryBuilder();
        $qb->update('RK\WebsiteHelperModule\Entity\LinkerEntity', 'tbl')
        ...
        $logArgs = ['app' => 'RKWebsiteHelperModule', 'user' => $currentUserApi->get('uname'), 'entities' => 'linkers', 'userid' => $userId];
    ...
    protected function getCountQuery($where = '', $useJoins = true)
    {
        ...
        $qb = $this->getEntityManager()->createQueryBuilder();
        $qb->select($selection)
           ->from('RK\WebsiteHelperModule\Entity\LinkerEntity', 'tbl');
