...
abstract class AbstractCarouselRepository extends EntityRepository
{
    ...
    public function truncateTable(LoggerInterface $logger)
    {
        ...
        $qb->delete('RK\WebsiteHelperModule\Entity\CarouselEntity', 'tbl');
        $query = $qb->getQuery();
    
        $query->execute();
    
        $logArgs = ['app' => 'RKWebsiteHelperModule', 'entity' => 'carousel'];
    ...
    public function updateCreator($userId, $newUserId, TranslatorInterface $translator, LoggerInterface $logger, CurrentUserApi $currentUserApi)
    {
        ...
        $qb = $this->getEntityManager()->createQueryBuilder();
        $qb->update('RK\WebsiteHelperModule\Entity\CarouselEntity', 'tbl')
        ...
        $logArgs = ['app' => 'RKWebsiteHelperModule', 'user' => $currentUserApi->get('uname'), 'entities' => 'carousells', 'userid' => $userId];
    ...
    protected function getCountQuery($where = '', $useJoins = true)
    {
        ...
        $qb = $this->getEntityManager()->createQueryBuilder();
        $qb->select($selection)
           ->from('RK\WebsiteHelperModule\Entity\CarouselEntity', 'tbl');
