 ...
 *
 * This is the base factory class for carousel entities.
 */
abstract class AbstractCarouselFactory
{
    /**
     * @var String Full qualified class name to be used for carousells.
     */
    protected $className;
     ...
     * @param String        $className Full qualified class name to be used for carousells
     */
