 ...
 *
 * This is the base factory class for carousel item entities.
 */
abstract class AbstractCarouselItemFactory
{
    /**
     * @var String Full qualified class name to be used for carousel items.
     */
    protected $className;
     ...
     * @param String        $className Full qualified class name to be used for carousel items
     */
