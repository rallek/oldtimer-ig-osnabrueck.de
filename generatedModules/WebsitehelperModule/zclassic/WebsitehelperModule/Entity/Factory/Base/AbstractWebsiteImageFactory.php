 ...
 *
 * This is the base factory class for website image entities.
 */
abstract class AbstractWebsiteImageFactory
{
    /**
     * @var String Full qualified class name to be used for website images.
     */
    protected $className;
     ...
     * @param String        $className Full qualified class name to be used for website images
     */
