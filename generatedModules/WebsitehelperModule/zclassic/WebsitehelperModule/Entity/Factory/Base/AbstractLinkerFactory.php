 ...
 *
 * This is the base factory class for linker entities.
 */
abstract class AbstractLinkerFactory
{
    /**
     * @var String Full qualified class name to be used for linkers.
     */
    protected $className;
     ...
     * @param String        $className Full qualified class name to be used for linkers
     */
