...
abstract class AbstractThirdPartyListener implements EventSubscriberInterface
{
    ...
    public function contentGetTypes(\Zikula_Event $event)
    {
        ...
        $types->add('RKWebsiteHelperModule_ContentType_Item');
        
        // plugin for showing a list of multiple items
        $types->add('RKWebsiteHelperModule_ContentType_ItemList');
    }
     ...
     * RKWebsiteHelperModule will use this to add a javascript helper to add custom items.
     *
     * @param \Zikula_Event $event The event instance
     */
    public function getEditorHelpers(\Zikula_Event $event)
    {
        ...
        $helpers->add(
            [
                ...
                'type'   => 'javascript',
                'path'   => 'modules/RK/WebsiteHelperModule/Resources/public/js/RKWebsiteHelperModule.Finder.js'
            ]
        );
    }
    ...
    public function getTinyMcePlugins(\Zikula_Event $event)
    {
        ...
        $plugins->add(
            [
                'name' => 'rkwebsitehelpermodule',
                'path' => 'modules/RK/WebsiteHelperModule/Resources/docs/scribite/plugins/TinyMce/vendor/tinymce/plugins/rkwebsitehelpermodule/plugin.js'
            ]
        );
    }
    ...
    public function getCKEditorPlugins(\Zikula_Event $event)
    {
        ...
        $plugins->add(
            [
                'name' => 'rkwebsitehelpermodule',
                'path' => 'modules/RK/WebsiteHelperModule/Resources/docs/scribite/plugins/CKEditor/vendor/ckeditor/plugins/rkwebsitehelpermodule/',
                'file' => 'plugin.js',
                'img'  => 'ed_rkwebsitehelpermodule.gif'
            ]
        );
    }
}
