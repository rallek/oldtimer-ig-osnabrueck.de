...
use RK\WebsiteHelperModule\Listener\Base\AbstractModuleDispatchListener;
...
class ModuleDispatchListener extends AbstractModuleDispatchListener
{
    ...
    public function serviceLinks(GenericEvent $event)
    {
        ...
        // $event->data[] = ['url' => $serviceManager->get('router')->generate('rkwebsitehelpermodule_user_index'), 'text' => $serviceManager->get('translator.default')->__('Link text')];
