...
use RK\WebsitehelperModule\Controller\Base\AbstractCarouselController;
...
class CarouselController extends AbstractCarouselController
{
     ...
     *
     * @Route("/admin/carousel/{id}.{_format}",
     *        requirements = {"id" = "\d+", "_format" = "html"},
     *        defaults = {"_format" = "html"},
     *        methods = {"GET"}
     * )
    ...
    {
        return parent::adminDisplayAction($request, $carousel);
    }
    
    /**
     * This action provides a item detail view.
     *
     * @Route("/carousel/{id}.{_format}",
     *        requirements = {"id" = "\d+", "_format" = "html"},
     *        defaults = {"_format" = "html"},
     *        methods = {"GET"}
     * )
    ...
    {
        return parent::displayAction($request, $carousel);
    }
