...
abstract class AbstractLinkerController extends AbstractController
{
    ...
    protected function indexInternal(Request $request, $isAdmin = false)
    {
        ...
        $objectType = 'linker';
        $utilArgs = ['controller' => 'linker', 'action' => 'index'];
        ...
        if ($isAdmin) {
            ...
            return $this->redirectToRoute('rkwebsitehelpermodule_linker_' . ($isAdmin ? 'admin' : '') . 'view');
        }
    ...
    protected function viewInternal(Request $request, $sort, $sortdir, $pos, $num, $isAdmin = false)
    {
        // parameter specifying which type of objects we are treating
        $objectType = 'linker';
        $utilArgs = ['controller' => 'linker', 'action' => 'view'];
        ...
        $currentUrlObject = new RouteUrl('rkwebsitehelpermodule_linker_' . /*($isAdmin ? 'admin' : '') . */'view', $currentUrlArgs);
    ...
    protected function displayInternal(Request $request, LinkerEntity $linker, $isAdmin = false)
    {
        // parameter specifying which type of objects we are treating
        $objectType = 'linker';
        $utilArgs = ['controller' => 'linker', 'action' => 'display'];
        $permLevel = $isAdmin ? ACCESS_ADMIN : ACCESS_READ;
        if (!$this->hasPermission($this->name . ':' . ucfirst($objectType) . ':', '::', $permLevel)) {
            throw new AccessDeniedException();
        }
        ...
        $currentUrlArgs['_locale'] = $request->getLocale();
        $currentUrlObject = new RouteUrl('rkwebsitehelpermodule_linker_' . /*($isAdmin ? 'admin' : '') . */'display', $currentUrlArgs);
    ...
    protected function editInternal(Request $request, $isAdmin = false)
    {
        // parameter specifying which type of objects we are treating
        $objectType = 'linker';
        $utilArgs = ['controller' => 'linker', 'action' => 'edit'];
    ...
    protected function deleteInternal(Request $request, LinkerEntity $linker, $isAdmin = false)
    {
        // parameter specifying which type of objects we are treating
        $objectType = 'linker';
        $utilArgs = ['controller' => 'linker', 'action' => 'delete'];
        ...
        $logArgs = ['app' => 'RKWebsiteHelperModule', 'user' => $this->get('zikula_users_module.current_user')->get('uname'), 'entity' => 'linker', 'id' => $entity->createCompositeIdentifier()];
