...
abstract class AbstractWebsiteImageController extends AbstractController
{
    ...
    protected function indexInternal(Request $request, $isAdmin = false)
    {
        ...
        $utilArgs = ['controller' => 'websiteImage', 'action' => 'index'];
        ...
        if ($isAdmin) {
            ...
            return $this->redirectToRoute('rkwebsitehelpermodule_websiteimage_' . ($isAdmin ? 'admin' : '') . 'view');
        }
    ...
    protected function viewInternal(Request $request, $sort, $sortdir, $pos, $num, $isAdmin = false)
    {
        // parameter specifying which type of objects we are treating
        $objectType = 'websiteImage';
        $utilArgs = ['controller' => 'websiteImage', 'action' => 'view'];
        ...
        $currentUrlObject = new RouteUrl('rkwebsitehelpermodule_websiteImage_' . /*($isAdmin ? 'admin' : '') . */'view', $currentUrlArgs);
    ...
    protected function displayInternal(Request $request, WebsiteImageEntity $websiteImage, $isAdmin = false)
    {
        // parameter specifying which type of objects we are treating
        $objectType = 'websiteImage';
        $utilArgs = ['controller' => 'websiteImage', 'action' => 'display'];
        $permLevel = $isAdmin ? ACCESS_ADMIN : ACCESS_READ;
        if (!$this->hasPermission($this->name . ':' . ucfirst($objectType) . ':', '::', $permLevel)) {
            throw new AccessDeniedException();
        }
        ...
        $currentUrlArgs['_locale'] = $request->getLocale();
        $currentUrlObject = new RouteUrl('rkwebsitehelpermodule_websiteImage_' . /*($isAdmin ? 'admin' : '') . */'display', $currentUrlArgs);
    ...
    protected function editInternal(Request $request, $isAdmin = false)
    {
        // parameter specifying which type of objects we are treating
        $objectType = 'websiteImage';
        $utilArgs = ['controller' => 'websiteImage', 'action' => 'edit'];
    ...
    protected function deleteInternal(Request $request, WebsiteImageEntity $websiteImage, $isAdmin = false)
    {
        // parameter specifying which type of objects we are treating
        $objectType = 'websiteImage';
        $utilArgs = ['controller' => 'websiteImage', 'action' => 'delete'];
        ...
        $logArgs = ['app' => 'RKWebsiteHelperModule', 'user' => $this->get('zikula_users_module.current_user')->get('uname'), 'entity' => 'website image', 'id' => $entity->createCompositeIdentifier()];
