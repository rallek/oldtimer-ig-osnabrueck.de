 ...
 */
function RKWebsitehelperModule_operation_delete(&$entity, $params)
{
    ...
    $logArgs = ['app' => 'RKWebsitehelperModule', 'user' => $serviceManager->get('zikula_users_module.current_user')->get('uname')];
