...
abstract class AbstractCarouselItemEntity extends EntityAccess
{
    ...
    /**
     * The title color normally should not be changed. If you have to because the choosen image do have a similar color please select white or black. (#ffffff or #000000)
     * @ORM\Column(length=255)
     * @Assert\NotNull()
     ...
     *
     * @ORM\ManyToOne(targetEntity="RK\WebsitehelperModule\Entity\CarouselEntity", inversedBy="carouselItems")
     * @ORM\JoinTable(name="rk_websit_carousel")
     * @Assert\Type(type="RK\WebsitehelperModule\Entity\CarouselEntity")
     * @Assert\Valid()
     * @var \RK\WebsitehelperModule\Entity\CarouselEntity $carousel
     */
    protected $carousel;
    ...
    public function setItemStartDate($itemStartDate)
    {
        ...
        } else if (is_null($itemStartDate) || empty($itemStartDate)) {
     ...
     *
     * @return \RK\WebsitehelperModule\Entity\CarouselEntity
     */
     ...
     * Sets the carousel.
     *
     * @param \RK\WebsitehelperModule\Entity\CarouselEntity $carousel
     *
     * @return void
     */
    ...
    {
        return 'rkwebsitehelpermodule.ui_hooks.carouselitems';
    }
    ...
    {
        return 'Carousel item ' . $this->createCompositeIdentifier();
    }
