...
use RK\WebsitehelperModule\Entity\Factory\CarouselItemFactory;
...
abstract class AbstractCarouselItemType extends AbstractType
{
     ...
     * @param CarouselItemFactory        $entityFactory Entity factory service instance
     * @param ListEntriesHelper   $listHelper    ListEntriesHelper service instance
     */
    public function __construct(TranslatorInterface $translator, CarouselItemFactory $entityFactory, ListEntriesHelper $listHelper)
    {
    ...
    public function addEntityFields(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('titleColor', 'RK\WebsitehelperModule\Form\Type\Field\ColourType', [
            ...
            'label_attr' => [
                'class' => 'tooltips',
                'title' => $this->__('The title color normally should not be changed. If you have to because the choosen image do have a similar color please select white or black. (#ffffff or #000000)')
            ],
            'help' => $this->__('The title color normally should not be changed. If you have to because the choosen image do have a similar color please select white or black. (#ffffff or #000000)'),
            'empty_data' => '',
            'attr' => [
