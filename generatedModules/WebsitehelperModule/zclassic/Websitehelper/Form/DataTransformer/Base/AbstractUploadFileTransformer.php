...
namespace RK\WebsitehelperModule\Form\DataTransformer\Base;
...
use RK\WebsitehelperModule\Form\Type\Field\UploadType;
use RK\WebsitehelperModule\Helper\ControllerHelper;
use RK\WebsitehelperModule\UploadHandler;
...
abstract class AbstractUploadFileTransformer implements DataTransformerInterface
{
    ...
    public function __construct(UploadType $formType, $fieldName)
    {
        ...
        $this->controllerHelper = ServiceUtil::get('rk_websitehelper_module.controller_helper');
        $this->uploadHandler = ServiceUtil::get('rk_websitehelper_module.upload_handler');
    ...
    public function reverseTransform($data)
    {
        ...
        if (null === $uploadedFile) {
            // check files array
            $filesKey = 'rkwebsitehelpermodule_' . $objectType;
