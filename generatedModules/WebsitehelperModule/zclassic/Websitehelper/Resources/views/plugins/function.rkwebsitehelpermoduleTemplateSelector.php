...
/**
 * The rkwebsitehelpermoduleTemplateSelector plugin provides items for a dropdown selector.
 *
 ...
 */
function smarty_function_rkwebsitehelpermoduleTemplateSelector($params, $view)
{
    $result = [];
