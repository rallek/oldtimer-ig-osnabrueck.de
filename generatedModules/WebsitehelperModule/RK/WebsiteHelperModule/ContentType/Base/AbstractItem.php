...
abstract class AbstractItem extends \Content_AbstractContentType implements ContainerAwareInterface
{
    ...
    {
        return $this->container->get('translator.default')->__('RKWebsiteHelperModule detail view');
    }
    ...
    {
        return $this->container->get('translator.default')->__('Display or link a single RKWebsiteHelperModule object.');
    }
    ...
    public function display()
    {
        if (null !== $this->id && !empty($this->displayMode)) {
            return $this->container->get('router')->generate('rkwebsitehelpermodule_external_display', $this->getDisplayArguments());
        }
