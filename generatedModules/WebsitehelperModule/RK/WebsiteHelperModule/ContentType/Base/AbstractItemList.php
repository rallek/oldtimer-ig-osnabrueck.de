...
abstract class AbstractItemList extends \Content_AbstractContentType implements ContainerAwareInterface
{
    ...
    {
        return $this->container->get('translator.default')->__('RKWebsiteHelperModule list view');
    }
    ...
    {
        return $this->container->get('translator.default')->__('Display list of RKWebsiteHelperModule objects.');
    }
    ...
    {
        $repository = $this->container->get('rk_websitehelper_module.entity_factory')->getRepository($objectType);
        ...
        $imageHelper = $this->container->get('rk_websitehelper_module.image_helper');
        ...
        return $this->container->get('twig')->render('@RKWebsiteHelperModule/' . $template, $templateParameters);
    }
    ...
    public function startEditing()
    {
        ...
        $this->view->toplevelmodule = 'RKWebsiteHelperModule';
    
        // ensure our custom plugins are loaded
        array_push($this->view->plugins_dir, 'modules/RK/WebsiteHelperModule/Resources/views//plugins');
    }
