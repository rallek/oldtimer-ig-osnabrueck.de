...
namespace RK\WebsiteHelperModule\Block\Base;
...
abstract class AbstractItemListBlock extends AbstractBlockHandler
{
    ...
    public function display(array $properties)
    {
        ...
        if (!$this->hasPermission('RKWebsiteHelperModule:ItemListBlock:', "$properties[title]::", ACCESS_OVERVIEW)) {
            return false;
        }
        ...
        if (empty($properties['title'])) {
            $properties['title'] = $this->__('RKWebsiteHelperModule items');
        }
    ...
    protected function getDisplayTemplate(array $properties)
    {
        ...
        foreach ($templateOptions as $templatePath) {
            if ($templating->exists('@RKWebsiteHelperModule/' . $templatePath)) {
                $template = '@RKWebsiteHelperModule/' . $templatePath;
                break;
            }
        }
    ...
    {
        return 'RK\WebsiteHelperModule\Block\Form\Type\ItemListBlockType';
    }
    ...
    {
        return '@RKWebsiteHelperModule/Block/itemlist_modify.html.twig';
    }
