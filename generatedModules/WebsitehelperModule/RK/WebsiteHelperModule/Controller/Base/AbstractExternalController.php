...
abstract class AbstractExternalController extends AbstractController
{
    ...
    public function displayAction($objectType, $id, $source, $displayMode)
    {
        ...
        return $this->render('@RKWebsiteHelperModule/External/' . ucfirst($objectType) . '/display.html.twig', $templateParameters);
    }
    ...
    public function finderAction(Request $request, $objectType, $editor, $sort, $sortdir, $pos = 1, $num = 0)
    {
        ...
        if (!$this->hasPermission('RKWebsiteHelperModule:' . ucfirst($objectType) . ':', '::', ACCESS_COMMENT)) {
        ...
        $output = $this->renderView('@RKWebsiteHelperModule/External/' . ucfirst($objectType) . '/find.html.twig', $templateParameters);
