...
abstract class AbstractCarouselItemController extends AbstractController
{
    ...
    protected function indexInternal(Request $request, $isAdmin = false)
    {
        ...
        return $this->redirectToRoute('rkwebsitehelpermodule_carouselitem_' . $templateParameters['routeArea'] . 'view');
    ...
    protected function deleteInternal(Request $request, CarouselItemEntity $carouselItem, $isAdmin = false)
    {
        ...
        $logArgs = ['app' => 'RKWebsiteHelperModule', 'user' => $this->get('zikula_users_module.current_user')->get('uname'), 'entity' => 'carousel item', 'id' => $carouselItem->createCompositeIdentifier()];
        ...
        $form = $this->createForm('RK\WebsiteHelperModule\Form\DeleteEntityType', $carouselItem);
