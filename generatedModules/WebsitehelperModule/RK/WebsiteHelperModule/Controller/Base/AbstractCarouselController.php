...
abstract class AbstractCarouselController extends AbstractController
{
    ...
    protected function indexInternal(Request $request, $isAdmin = false)
    {
        ...
        return $this->redirectToRoute('rkwebsitehelpermodule_carousel_' . $templateParameters['routeArea'] . 'view');
    ...
    protected function deleteInternal(Request $request, CarouselEntity $carousel, $isAdmin = false)
    {
        ...
        $logArgs = ['app' => 'RKWebsiteHelperModule', 'user' => $this->get('zikula_users_module.current_user')->get('uname'), 'entity' => 'carousel', 'id' => $carousel->createCompositeIdentifier()];
        ...
        $form = $this->createForm('RK\WebsiteHelperModule\Form\DeleteEntityType', $carousel);
