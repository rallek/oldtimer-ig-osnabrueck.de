...
/**
 * Website image finder form type base class.
 */
abstract class AbstractWebsiteImageFinderType extends AbstractType
{
    use TranslatorTrait;

    /**
     * WebsiteImageFinderType constructor.
     *
    ...
    public function addPasteAsField(FormBuilderInterface $builder, array $options)
    {
        $builder->add('pasteas', 'Symfony\Component\Form\Extension\Core\Type\ChoiceType', [
            ...
            'empty_data' => 1,
            'choices' => [
                $this->__('Link to the website image') => 1,
                $this->__('ID of website image') => 2
            ],
    ...
    {
        return 'rkwebsitehelpermodule_websiteimagefinder';
    }
