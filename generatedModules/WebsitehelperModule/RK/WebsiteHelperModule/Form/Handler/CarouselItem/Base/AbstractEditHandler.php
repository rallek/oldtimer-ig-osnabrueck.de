...
abstract class AbstractEditHandler extends EditHandler
{
    ...
    protected function createForm()
    {
        ...
        return $this->formFactory->create('RK\WebsiteHelperModule\Form\Type\CarouselItemType', $this->entityRef, $options);
    }
    ...
    public function applyAction(array $args = [])
    {
        ...
        try {
            ...
            $logArgs = ['app' => 'RKWebsiteHelperModule', 'user' => $this->currentUserApi->get('uname'), 'entity' => 'carousel item', 'id' => $entity->createCompositeIdentifier(), 'errorMessage' => $e->getMessage()];
    ...
    protected function getRedirectUrl($args)
    {
        ...
        switch ($this->returnTo) {
            ...
            case 'adminViewCarousells':
                return $this->router->generate('rkwebsitehelpermodule_carousel_' . $routeArea . 'view');
            case 'userOwnViewCarousells':
            case 'adminOwnViewCarousells':
                return $this->router->generate('rkwebsitehelpermodule_carousel_' . $routeArea . 'view', [ 'own' => 1 ]);
            default:
                return $this->getDefaultReturnUrl($args);
        }
    }
