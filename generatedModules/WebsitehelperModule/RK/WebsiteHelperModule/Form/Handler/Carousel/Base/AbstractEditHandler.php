...
abstract class AbstractEditHandler extends EditHandler
{
    ...
    protected function createForm()
    {
        ...
        return $this->formFactory->create('RK\WebsiteHelperModule\Form\Type\CarouselType', $this->entityRef, $options);
    }
    ...
    public function applyAction(array $args = [])
    {
        ...
        try {
            ...
            $logArgs = ['app' => 'RKWebsiteHelperModule', 'user' => $this->currentUserApi->get('uname'), 'entity' => 'carousel', 'id' => $entity->createCompositeIdentifier(), 'errorMessage' => $e->getMessage()];
