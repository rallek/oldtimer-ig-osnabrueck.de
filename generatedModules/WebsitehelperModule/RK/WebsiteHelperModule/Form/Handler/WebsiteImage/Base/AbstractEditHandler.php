...
abstract class AbstractEditHandler extends EditHandler
{
    ...
    public function processForm(array $templateParameters)
    {
        ...
        if ($this->templateParameters['mode'] == 'create') {
            if (!$this->modelHelper->canBeCreated($this->objectType)) {
                ...
                $logArgs = ['app' => 'RKWebsiteHelperModule', 'user' => $this->currentUserApi->get('uname'), 'entity' => $this->objectType];
    ...
    protected function createForm()
    {
        ...
        return $this->formFactory->create('RK\WebsiteHelperModule\Form\Type\WebsiteImageType', $this->entityRef, $options);
    }
    ...
    protected function getRedirectCodes()
    {
        ...
        // user index page of website image area
        $codes[] = 'userIndex';
        // admin index page of website image area
        $codes[] = 'adminIndex';
        // user list of website images
        $codes[] = 'userView';
        // admin list of website images
        $codes[] = 'adminView';
        // user list of own website images
        $codes[] = 'userOwnView';
        // admin list of own website images
        $codes[] = 'adminOwnView';
        // user detail page of treated website image
        $codes[] = 'userDisplay';
        // admin detail page of treated website image
        $codes[] = 'adminDisplay';
    ...
    protected function getDefaultReturnUrl($args)
    {
        ...
        $routePrefix = 'rkwebsitehelpermodule_' . $this->objectTypeLower . '_' . $routeArea;
    ...
    public function applyAction(array $args = [])
    {
        ...
        try {
            ...
            $logArgs = ['app' => 'RKWebsiteHelperModule', 'user' => $this->currentUserApi->get('uname'), 'entity' => 'website image', 'id' => $entity->createCompositeIdentifier(), 'errorMessage' => $e->getMessage()];
    ...
    protected function getRedirectUrl($args)
    {
        ...
        if ($this->request->getSession()->has('rkwebsitehelpermoduleReferer')) {
            $this->request->getSession()->del('rkwebsitehelpermoduleReferer');
        }
