...
abstract class AbstractSelectionHelper
{
     ...
     */
    public function __construct(TranslatorInterface $translator, WebsiteHelperFactory $entityFactory)
    {
    ...
    public function getIdFields($objectType = '')
    {
        ...
        $entityClass = 'RKWebsiteHelperModule:' . ucfirst($objectType) . 'Entity';
