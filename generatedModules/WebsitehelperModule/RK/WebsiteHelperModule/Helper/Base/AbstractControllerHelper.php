...
abstract class AbstractControllerHelper
{
    ...
    /**
     * Returns an array of all allowed object types in RKWebsiteHelperModule.
     *
    ...
    public function getObjectTypes($context = '', $args = [])
    {
        ...
        $allowedObjectTypes[] = 'websiteImage';
    
        return $allowedObjectTypes;
    }

    /**
     * Returns the default object type in RKWebsiteHelperModule.
     *
     * @param string $context Usage context (allowed values: controllerAction, api, helper, actionHandler, block, contentType, util)
     * @param array  $args    Additional arguments
     *
    ...
    public function processViewActionParameters($objectType, SortableColumns $sortableColumns, array $templateParameters = [], $supportsHooks = false)
    {
        ...
        $showOwnEntries = $request->query->getInt('own', $this->variableApi->get('RKWebsiteHelperModule', 'showOnlyOwnEntries', 0));
        ...
        if ($showAllEntries != 1) {
            ...
            if (in_array($resultsPerPage, [0, 10])) {
                $resultsPerPage = $this->variableApi->get('RKWebsiteHelperModule', $objectType . 'EntriesPerPage', 10);
            }
        }
        ...
        $quickNavForm = $this->formFactory->create('RK\WebsiteHelperModule\Form\Type\QuickNavigation\\' . ucfirst($objectType) . 'QuickNavType', $templateParameters);
        ...
        if (true === $supportsHooks) {
            ...
            $currentUrlObject = new RouteUrl('rkwebsitehelpermodule_' . $objectType . '_' . /*$templateParameters['routeArea'] . */'view', $currentUrlArgs);
        }
    ...
    public function processDisplayActionParameters($objectType, array $templateParameters = [], $supportsHooks = false)
    {
        ...
        if (true === $supportsHooks) {
            ...
            $currentUrlObject = new RouteUrl('rkwebsitehelpermodule_' . $objectType . '_' . /*$templateParameters['routeArea'] . */'display', $currentUrlArgs);
            $templateParameters['currentUrlObject'] = $currentUrlObject;
        }
