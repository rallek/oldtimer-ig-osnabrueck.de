...
abstract class AbstractWebsiteHelperModuleInstaller extends AbstractExtensionInstaller
{
    ...
    public function install()
    {
        ...
        try {
            ...
            $uploadHelper = new \RK\WebsiteHelperModule\Helper\UploadHelper($container->get('translator.default'), $container->get('session'), $container->get('logger'), $container->get('zikula_users_module.current_user'), $container->get('zikula_extensions_module.api.variable'), $container->getParameter('datadir'));
        ...
        $this->setVar('websiteImageEntriesPerPage', 10);
        ...
        $this->setVar('thumbnailModeWebsiteImageMyImage',  'inset' );
