...
namespace RK\WebsiteHelperModule\Traits;
...
trait EntityWorkflowTrait
{
    ...
    {
        $entityClass = 'RKWebsiteHelperModule:' . ucfirst($this->get_objectType()) . 'Entity';
    ...
    public function initWorkflow($forceLoading = false)
    {
        ...
        if (($loadingRequired && !$isReuse) || $forceLoading) {
            $result = Zikula_Workflow_Util::getWorkflowForObject($this, $objectType, $idColumn, 'RKWebsiteHelperModule');
            if (!$result) {
    ...
    public function resetWorkflow()
    {
        ...
        $workflowHelper = ServiceUtil::get('rk_websitehelper_module.workflow_helper');
