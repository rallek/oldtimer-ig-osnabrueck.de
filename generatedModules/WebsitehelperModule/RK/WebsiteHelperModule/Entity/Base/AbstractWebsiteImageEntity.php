 ...
 *
 * This is the base entity class for website image entities.
 ...
 * @abstract
 */
abstract class AbstractWebsiteImageEntity extends EntityAccess
{
    /**
     ...
     */
    protected $_objectType = 'websiteImage';
    ...
    /**
     * WebsiteImageEntity constructor.
     *
    ...
    public static function getWorkflowStateAllowedValues()
    {
        ...
        $listEntries = $helper->getWorkflowStateEntriesForWebsiteImage();
    ...
    {
        return 'rkwebsitehelpermodule.ui_hooks.websiteimages';
    }
    ...
    {
        return 'Website image ' . $this->createCompositeIdentifier() . ': ' . $this->getTitleFromDisplayPattern();
    }
