...
abstract class AbstractUserListener implements EventSubscriberInterface
{
     ...
     * @return void
     */
    public function __construct(ZkTranslatorInterface $translator, WebsiteHelperFactory $entityFactory, CurrentUserApi $currentUserApi, LoggerInterface $logger)
    {
    ...
    public function delete(GenericEvent $event)
    {
        ...
        $logArgs = ['app' => 'RKWebsiteHelperModule', 'user' => $this->currentUserApi->get('uname'), 'entities' => 'linkers'];
        ...
        $logArgs = ['app' => 'RKWebsiteHelperModule', 'user' => $this->currentUserApi->get('uname'), 'entities' => 'carousel items'];
        $this->logger->notice('{app}: User {user} has been deleted, so we deleted/updated corresponding {entities}, too.', $logArgs);
        ...
        $logArgs = ['app' => 'RKWebsiteHelperModule', 'user' => $this->currentUserApi->get('uname'), 'entities' => 'carousells'];
        $this->logger->notice('{app}: User {user} has been deleted, so we deleted/updated corresponding {entities}, too.', $logArgs);
        
        $repo = $this->entityFactory->getRepository('websiteImage');
        ...
        $logArgs = ['app' => 'RKWebsiteHelperModule', 'user' => $this->currentUserApi->get('uname'), 'entities' => 'website images'];
        $this->logger->notice('{app}: User {user} has been deleted, so we deleted/updated corresponding {entities}, too.', $logArgs);
    }
}
