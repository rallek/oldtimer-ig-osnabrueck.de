...
use RK\DownloadModule\UploadHandler;
...
abstract class AbstractUploadFileTransformer implements DataTransformerInterface
{
    ...
    public function __construct(UploadType $formType, $fieldName)
    {
        ...
        $this->controllerHelper = ServiceUtil::get('rk_download_module.controller_helper');
        $this->uploadHandler = ServiceUtil::get('rk_download_module.upload_handler');
