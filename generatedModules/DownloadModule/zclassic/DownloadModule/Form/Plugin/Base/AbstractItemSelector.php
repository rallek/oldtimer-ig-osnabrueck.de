...
class AbstractItemSelector extends Zikula_Form_Plugin_TextInput
{
    ...
    public function render(Zikula_Form_View $view)
    {
        ...
        if ($firstTime) {
            ...
            PageUtil::addVar('javascript', '@RKDownloadModule/Resources/public/js/RKDownloadModule.Finder.js');
    ...
    {
        parent::decode($view);
        $this->objectType = FormUtil::getPassedValue('RKDownloadModule_objecttype', 'file', 'POST');
        $this->selectedItemId = $this->text;
    }
}
