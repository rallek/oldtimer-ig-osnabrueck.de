...
abstract class AbstractDownloadModuleInstaller extends AbstractExtensionInstaller
{
    ...
    public function install()
    {
        ...
        try {
            ...
            $controllerHelper = new \RK\DownloadModule\Helper\ControllerHelper($container, $container->get('translator.default'), $container->get('session'), $container->get('logger'));
        ...
        $registry->setProperty($categoryHelper->getPrimaryProperty(['ot' => 'File']));
        ...
        try {
            ...
            $this->addFlash('error', $this->__f('Error! Could not create a category registry for the %s entity.', ['%s' => 'file']));
    ...
    */
    ...
    public function uninstall()
    {
        ...
        if (false === $result) {
            $this->addFlash('error', $this->__f('An error was encountered while removing stored object workflows for the %s extension.', ['%s' => 'RKDownloadModule']));
        ...
        DBUtil::deleteWhere('categories_registry', 'modname = \'RKDownloadModule\'');
    
        // remove all thumbnails
        $manager = $this->container->get('systemplugin.imagine.manager');
        $manager->setModule('RKDownloadModule');
