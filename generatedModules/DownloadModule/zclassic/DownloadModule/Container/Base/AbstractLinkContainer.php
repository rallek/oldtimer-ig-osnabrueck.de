    ...
    public function getLinks($type = LinkContainerInterface::TYPE_ADMIN)
    {
        ...
        if (LinkContainerInterface::TYPE_ADMIN == $type) {
            if ($this->permissionApi->hasPermission($this->getBundleName() . '::', '::', ACCESS_READ)) {
                $links[] = [
                    'url' => $this->router->generate('rkdownloadmodule_user_index'),
            ...
            if (in_array('file', $allowedObjectTypes)
                ...
                $links[] = [
                    'url' => $this->router->generate('rkdownloadmodule_file_adminview'),
                     'text' => $this->__('Files'),
        ...
        if (LinkContainerInterface::TYPE_USER == $type) {
            if ($this->permissionApi->hasPermission($this->getBundleName() . '::', '::', ACCESS_ADMIN)) {
                $links[] = [
                    'url' => $this->router->generate('rkdownloadmodule_admin_index'),
            ...
            if (in_array('file', $allowedObjectTypes)
                && $this->permissionApi->hasPermission($this->getBundleName() . ':File:', '::', $permLevel)) {
                $links[] = [
                    'url' => $this->router->generate('rkdownloadmodule_file_view'),
                     'text' => $this->__('Files'),
                     'title' => $this->__('File list')
                 ];
            }
