...
abstract class AbstractItemList extends \Content_AbstractContentType
{
    ...
    public function getTitle()
    {
        ...
        return $serviceManager->get('translator.default')->__('RKDownloadModule list view');
    }
    ...
    public function getDescription()
    {
        ...
        return $serviceManager->get('translator.default')->__('Display list of RKDownloadModule objects.');
    }
    ...
    public function loadData(&$data)
    {
        ...
        $featureActivationHelper = $serviceManager->get('rk_download_module.feature_activation_helper');
        ...
        $categoryHelper = $serviceManager->get('rk_download_module.category_helper');
    
        // fetch category properties
        $this->catRegistries = [];
        $this->catProperties = [];
        if (in_array($this->objectType, $this->categorisableObjectTypes)) {
            $selectionHelper = $serviceManager->get('rk_download_module.selection_helper');
    ...
    public function display()
    {
        ...
        $serviceManager = ServiceUtil::getManager();
        $repository = $serviceManager->get('rk_download_module.' . $this->objectType . '_factory')->getRepository();
        ...
        $imageHelper = $serviceManager->get('rk_download_module.image_helper');
        ...
        $output = $serviceManager->get('twig')->render('@RKDownloadModule/' . $template, $templateParameters);
    ...
    protected function getSortParam($repository)
    {
        ...
        if ($this->sorting == 'newest') {
            $selectionHelper = ServiceUtil::get('rk_download_module.selection_helper');
            $idFields = $selectionHelper->getIdFields($this->objectType);
            if (count($idFields) == 1) {
    ...
    public function startEditing()
    {
        ...
        array_push($this->view->plugins_dir, 'modules/RKDownloadModule/Resources/views//plugins');
        ...
        ->assign('categoryHelper', $serviceManager->get('rk_download_module.category_helper'));
        }
    }
