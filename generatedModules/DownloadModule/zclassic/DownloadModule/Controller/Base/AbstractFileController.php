...
abstract class AbstractFileController extends AbstractController
{
    ...
    protected function indexInternal(Request $request, $isAdmin = false)
    {
        ...
        $objectType = 'file';
        $utilArgs = ['controller' => 'file', 'action' => 'index'];
        ...
        if ($isAdmin) {
            ...
            return $this->redirectToRoute('rkdownloadmodule_file_' . ($isAdmin ? 'admin' : '') . 'view');
        }
    ...
    protected function viewInternal(Request $request, $sort, $sortdir, $pos, $num, $isAdmin = false)
    {
        // parameter specifying which type of objects we are treating
        $objectType = 'file';
        $utilArgs = ['controller' => 'file', 'action' => 'view'];
        ...
        $quickNavForm = $this->createForm('RK\DownloadModule\Form\Type\QuickNavigation\\' . ucfirst($objectType) . 'QuickNavType', $templateParameters);
        ...
        $currentUrlObject = new RouteUrl('rkdownloadmodule_file_' . /*($isAdmin ? 'admin' : '') . */'view', $currentUrlArgs);
        ...
        $modelHelper = $this->get('rk_download_module.model_helper');
    ...
    protected function displayInternal(Request $request, FileEntity $file, $isAdmin = false)
    {
        // parameter specifying which type of objects we are treating
        $objectType = 'file';
        $utilArgs = ['controller' => 'file', 'action' => 'display'];
        $permLevel = $isAdmin ? ACCESS_ADMIN : ACCESS_READ;
        if (!$this->hasPermission($this->name . ':' . ucfirst($objectType) . ':', '::', $permLevel)) {
            throw new AccessDeniedException();
        }
        ...
        $currentUrlArgs['_locale'] = $request->getLocale();
        $currentUrlObject = new RouteUrl('rkdownloadmodule_file_' . /*($isAdmin ? 'admin' : '') . */'display', $currentUrlArgs);
    ...
    protected function editInternal(Request $request, $isAdmin = false)
    {
        // parameter specifying which type of objects we are treating
        $objectType = 'file';
        $utilArgs = ['controller' => 'file', 'action' => 'edit'];
    ...
    protected function deleteInternal(Request $request, FileEntity $file, $isAdmin = false)
    {
        // parameter specifying which type of objects we are treating
        $objectType = 'file';
        $utilArgs = ['controller' => 'file', 'action' => 'delete'];
        ...
        $logArgs = ['app' => 'RKDownloadModule', 'user' => $this->get('zikula_users_module.current_user')->get('uname'), 'entity' => 'file', 'id' => $entity->createCompositeIdentifier()];
        ...
        $form = $this->createForm('RK\DownloadModule\Form\DeleteEntityType', $entity);
