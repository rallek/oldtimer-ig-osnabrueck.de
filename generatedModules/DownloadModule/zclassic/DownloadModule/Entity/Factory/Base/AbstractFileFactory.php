 ...
 *
 * This is the base factory class for file entities.
 */
abstract class AbstractFileFactory
{
    /**
     * @var String Full qualified class name to be used for files.
     */
    protected $className;
     ...
     * @param String        $className Full qualified class name to be used for files
     */
