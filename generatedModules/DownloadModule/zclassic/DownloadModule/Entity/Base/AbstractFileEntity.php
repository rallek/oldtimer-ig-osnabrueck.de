...
abstract class AbstractFileEntity extends EntityAccess
{
    ...
    public function getTitleFromDisplayPattern()
    {
        ...
        $listHelper = $serviceManager->get('rk_download_module.listentries_helper');
    ...
    public function initWorkflow($forceLoading = false)
    {
        ...
        if ((!in_array($currentFunc, ['index', 'view', 'display']) && empty($isReuse)) || $forceLoading) {
            $result = Zikula_Workflow_Util::getWorkflowForObject($this, $this['_objectType'], $idColumn, 'RKDownLoadModule');
            if (!$result) {
    ...
    {
        return 'File ' . $this->createCompositeIdentifier();
    }
