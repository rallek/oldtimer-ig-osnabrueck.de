...
abstract class AbstractExternalController extends AbstractController
{
    ...
    public function displayAction($ot, $id, $source, $displayMode)
    {
        ...
        return $this->render('@RKSponsoringModule/External/' . ucfirst($objectType) . '/display.html.twig', $templateParameters);
    }
    ...
    public function finderAction($objectType, $editor, $sort, $sortdir, $pos = 1, $num = 0)
    {
        ...
        if (!$this->hasPermission('RKSponsoringModule:' . ucfirst($objectType) . ':', '::', ACCESS_COMMENT)) {
        ...
        $form = $this->createForm('RK\SponsoringModule\Form\Type\Finder\\' . ucfirst($objectType) . 'FinderType', $templateParameters, $formOptions);
        
        $templateParameters['finderForm'] = $form->createView();
        
        
        return $this->render('@RKSponsoringModule/External/' . ucfirst($objectType) . '/find.html.twig', $templateParameters);
    }
}
