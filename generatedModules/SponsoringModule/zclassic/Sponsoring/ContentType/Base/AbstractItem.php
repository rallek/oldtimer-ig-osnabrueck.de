...
abstract class AbstractItem extends \Content_AbstractContentType
{
    ...
    public function getTitle()
    {
        ...
        return $serviceManager->get('translator.default')->__('RKSponsoringModule detail view');
    }
    ...
    public function getDescription()
    {
        ...
        return $serviceManager->get('translator.default')->__('Display or link a single RKSponsoringModule object.');
    }
    ...
    public function display()
    {
        if (null !== $this->id && !empty($this->displayMode)) {
            return ModUtil::func('RKSponsoringModule', 'external', 'display', $this->getDisplayArguments());
        }
