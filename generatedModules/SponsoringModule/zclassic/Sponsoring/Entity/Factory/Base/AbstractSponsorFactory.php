...
namespace RK\SponsoringModule\Entity\Factory\Base;
 ...
 *
 * This is the base factory class for sponsor entities.
 */
abstract class AbstractSponsorFactory
{
    /**
     * @var String Full qualified class name to be used for sponsors.
     */
    protected $className;
     ...
     * @param String        $className Full qualified class name to be used for sponsors
     */
