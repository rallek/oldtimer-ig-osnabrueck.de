...
namespace RK\SponsoringModule\Form\Plugin\Base;
...
class AbstractItemSelector extends Zikula_Form_Plugin_TextInput
{
    ...
    public function render(Zikula_Form_View $view)
    {
        ...
        if ($firstTime) {
            ...
            PageUtil::addVar('javascript', '@RKSponsoringModule/Resources/public/js/RKSponsoringModule.Finder.js');
            PageUtil::addVar('stylesheet', '@RKSponsoringModule/Resources/public/css/style.css');
        }
        $firstTime = false;
        ...
        if (!$permissionApi->hasPermission('RKSponsoringModule:' . ucfirst($this->objectType) . ':', '::', ACCESS_COMMENT)) {
            return false;
        }
    ...
    {
        parent::decode($view);
        $this->objectType = FormUtil::getPassedValue('RKSponsoringModule_objecttype', 'sponsor', 'POST');
        $this->selectedItemId = $this->text;
    }
}
