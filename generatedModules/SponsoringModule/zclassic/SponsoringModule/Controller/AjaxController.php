...
use RK\SponsoringModule\Controller\Base\AbstractAjaxController;
...
class AjaxController extends AbstractAjaxController
{
    ...
    /**
     *
     * @Route("/getSponsorSponsoringUserUsers", options={"expose"=true})
     * @Method("GET")
     */
    public function getSponsorSponsoringUserUsersAction(Request $request)
    {
        return parent::getSponsorSponsoringUserUsersAction($request);
    }
