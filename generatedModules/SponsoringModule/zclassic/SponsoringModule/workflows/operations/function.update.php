 ...
 */
function RKSponsoringModule_operation_update(&$entity, $params)
{
    ...
    $logArgs = ['app' => 'RKSponsoringModule', 'user' => $serviceManager->get('zikula_users_module.current_user')->get('uname')];
