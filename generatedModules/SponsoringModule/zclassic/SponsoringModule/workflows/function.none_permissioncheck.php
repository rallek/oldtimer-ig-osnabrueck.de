 ...
 */
function RKSponsoringModule_workflow_none_permissioncheck($obj, $permLevel, $currentUser, $actionId)
{
    // every user is allowed to perform automatic archiving 
    if (true === \PageUtil::getVar('RKSponsoringModuleAutomaticArchiving', false)) {
        return true;
    }

    // calculate the permission component
    $objectType = $obj['_objectType'];
    $component = 'RKSponsoringModule:' . ucfirst($objectType) . ':';
 ...
 */
function RKSponsoringModule_workflow_none_gettextstrings()
{
