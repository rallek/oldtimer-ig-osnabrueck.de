...
<div style="margin-left: 80px">
    <div class="form-group">
        {formlabel for='rKSponsoringModuleObjectType' __text='Object type' cssClass='col-sm-3 control-label'}
        <div class="col-sm-9">
            {rksponsoringmoduleObjectTypeSelector assign='allObjectTypes'}
            {formdropdownlist id='rKSponsoringModuleObjectType' dataField='objectType' group='data' mandatory=true items=$allObjectTypes cssClass='form-control'}
    ...
    <div{* class="form-group"*}>
        ...
        {rksponsoringmoduleItemSelector id='id' group='data' objectType=$objectType}
    </div>
