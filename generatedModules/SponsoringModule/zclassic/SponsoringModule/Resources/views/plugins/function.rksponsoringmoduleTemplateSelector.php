...
/**
 * The rksponsoringmoduleTemplateSelector plugin provides items for a dropdown selector.
 *
 ...
 */
function smarty_function_rksponsoringmoduleTemplateSelector($params, $view)
{
    $result = [];
