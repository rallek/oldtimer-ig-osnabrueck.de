...
use RK\SponsoringModule\Listener\Base\AbstractModuleDispatchListener;
...
class ModuleDispatchListener extends AbstractModuleDispatchListener
{
    ...
    public function serviceLinks(GenericEvent $event)
    {
        ...
        // $event->data[] = ['url' => $serviceManager->get('router')->generate('rksponsoringmodule_user_index'), 'text' => $serviceManager->get('translator.default')->__('Link text')];
