...
abstract class AbstractThirdPartyListener implements EventSubscriberInterface
{
    ...
    public function contentGetTypes(\Zikula_Event $event)
    {
        ...
        $types->add('RKSponsoringModule_ContentType_Item');
        
        // plugin for showing a list of multiple items
        $types->add('RKSponsoringModule_ContentType_ItemList');
    }
     ...
     * RKSponsoringModule will use this to add a javascript helper to add custom items.
     *
     * @param \Zikula_Event $event The event instance
     */
    public function getEditorHelpers(\Zikula_Event $event)
    {
        ...
        $helpers->add(
            [
                ...
                'type'   => 'javascript',
                'path'   => 'modules/RK/SponsoringModule/Resources/public/js/RKSponsoringModule.Finder.js'
            ]
        );
    }
    ...
    public function getTinyMcePlugins(\Zikula_Event $event)
    {
        ...
        $plugins->add(
            [
                'name' => 'rksponsoringmodule',
                'path' => 'modules/RK/SponsoringModule/Resources/docs/scribite/plugins/TinyMce/vendor/tinymce/plugins/rksponsoringmodule/plugin.js'
            ]
        );
    }
    ...
    public function getCKEditorPlugins(\Zikula_Event $event)
    {
        ...
        $plugins->add(
            [
                'name' => 'rksponsoringmodule',
                'path' => 'modules/RK/SponsoringModule/Resources/docs/scribite/plugins/CKEditor/vendor/ckeditor/plugins/rksponsoringmodule/',
                'file' => 'plugin.js',
                'img'  => 'ed_rksponsoringmodule.gif'
            ]
        );
    }
}
