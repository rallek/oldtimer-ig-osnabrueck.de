...
namespace RK\SponsoringModule\Listener;

use RK\SponsoringModule\Listener\Base\AbstractKernelListener;
...
class KernelListener extends AbstractKernelListener
{
    ...
    public function onRequest(GetResponseEvent $event)
    {
        ...
        // $testMessage = 'Hello from sponsoring app';
        // $event->getRequest()->attributes->set('RKSponsoringModule_test', $testMessage);
    ...
    public function onResponse(FilterResponseEvent $event)
    {
        ...
        // $testMessage = $event->getRequest()->attributes->get('RKSponsoringModule_test');
        // now $testMessage should be: 'Hello from sponsoring app'
    ...
    public function onException(GetResponseForExceptionEvent $event)
    {
        ...
        //     || $exception instanceof MySpecialExceptionInterface) {
            ...
            // $message = sprintf(
            //     'sponsoring App Error says: %s with code: %s',
