...
abstract class AbstractListEntriesHelper
{
    ...
    public function getEntries($objectType, $fieldName)
    {
        ...
        switch ($objectType) {
            case 'sponsor':
                switch ($fieldName) {
                    case 'workflowState':
                        $entries = $this->getWorkflowStateEntriesForSponsor();
                        break;
                }
                break;
        }
     ...
     * @return array Array with desired list entries
     */
    public function getWorkflowStateEntriesForSponsor()
    {
        $states = [];
        $states[] = [
            'value'   => 'approved',
        ...
        $states[] = [
            ...
            'title'   => $this->translator->__('Content has reached the end and became archived.'),
            'image'   => '',
            'default' => false
        ];
        $states[] = [
        ...
        $states[] = [
            'value'   => '!archived',
            'text'    => $this->translator->__('All except archived'),
            'title'   => $this->translator->__('Shows all items except these which are archived'),
            'image'   => '',
            'default' => false
        ];
