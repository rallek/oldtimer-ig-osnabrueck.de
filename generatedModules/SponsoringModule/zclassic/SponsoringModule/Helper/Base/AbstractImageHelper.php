    ...
    public function getCustomRuntimeOptions($objectType = '', $fieldName = '', $contextName = '', $context = '', $args = [])
    {
        $options = [
            'thumbnail' => [
                ...
                'mode'      => $this->variableApi->get('RKSponsoringModule', 'thumbnailMode' . ucfirst($objectType), 'inset'),
        ...
        if ($contextName == $this->name . '_ajax_autocomplete') {
            ...
            if (in_array($args['action'], ['view', 'display', 'edit'])) {
                ...
                $options['thumbnail']['size'] = [
                    $this->variableApi->get('RKSponsoringModule', 'thumbnailWidth' . $fieldSuffix, $defaultWidth),
                    $this->variableApi->get('RKSponsoringModule', 'thumbnailHeight' . $fieldSuffix, $defaultHeight)
                ];
            }
        }
