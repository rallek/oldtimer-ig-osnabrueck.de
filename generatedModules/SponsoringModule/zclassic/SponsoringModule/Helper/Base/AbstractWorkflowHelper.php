...
abstract class AbstractWorkflowHelper
{
    ...
    public function getActionsForObject($entity)
    {
        ...
        $listHelper = $this->container->get('rk_sponsoring_module.listentries_helper');
    ...
    public function executeAction($entity, $actionId = '', $recursive = false)
    {
        ...
        $result = Zikula_Workflow_Util::executeAction($schemaName, $entity, $actionId, $objectType, 'RKSponsoringModule', $idColumn);
    ...
    public function normaliseWorkflowData(&$entity)
    {
        ...
        if (!is_object($workflow)) {
            $workflow['module'] = 'RKSponsoringModule';
    ...
    {
        $repository = $this->container->get('rk_sponsoring_module.' . $objectType . '_factory')->getRepository();
