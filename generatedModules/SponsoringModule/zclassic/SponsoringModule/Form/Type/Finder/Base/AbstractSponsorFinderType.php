...
namespace RK\SponsoringModule\Form\Type\Finder\Base;
...
/**
 * Sponsor finder form type base class.
 */
abstract class AbstractSponsorFinderType extends AbstractType
{
    use TranslatorTrait;

    /**
     * SponsorFinderType constructor.
     *
    ...
    public function addPasteAsField(FormBuilderInterface $builder, array $options)
    {
        $builder->add('pasteas', 'Symfony\Component\Form\Extension\Core\Type\ChoiceType', [
            ...
            'empty_data' => 1,
            'choices' => [
                $this->__('Link to the sponsor') => 1,
                $this->__('ID of sponsor') => 2
            ],
    ...
    {
        return 'rksponsoringmodule_sponsorfinder';
    }
