...
use RK\SponsoringModule\Form\DataTransformer\UploadFileTransformer;
...
abstract class AbstractUploadType extends AbstractType
{
    ...
    public function buildView(FormView $view, FormInterface $form, array $options)
    {
        ...
        if (true === $fileMeta['isImage']) {
            $imageHelper = ServiceUtil::get('rk_sponsoring_module.image_helper');
    ...
    {
        return 'rksponsoringmodule_field_upload';
    }
}
