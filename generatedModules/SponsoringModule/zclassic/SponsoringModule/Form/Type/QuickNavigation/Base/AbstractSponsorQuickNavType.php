...
namespace RK\SponsoringModule\Form\Type\QuickNavigation\Base;
...
/**
 * Sponsor quick navigation form type base class.
 */
abstract class AbstractSponsorQuickNavType extends AbstractType
{
    use TranslatorTrait;
    ...
    /**
     * SponsorQuickNavType constructor.
     *
    ...
    {
        $listEntries = $this->listHelper->getEntries('sponsor', 'workflowState');
        $choices = [];
        $choiceAttributes = [];
    ...
    {
        $builder->add('sponsoringUser', 'Symfony\Bridge\Doctrine\Form\Type\EntityType', [
    ...
    public function addSortingFields(FormBuilderInterface $builder, array $options)
    {
        $builder
            ->add('sort', 'Symfony\Component\Form\Extension\Core\Type\ChoiceType', [
                ...
                'choices' =>             [
                    $this->__('Sponsor name') => 'sponsorName',
                    $this->__('Sponsoring event') => 'sponsoringEvent',
                    $this->__('Logo') => 'logo',
                    $this->__('Description') => 'description',
                    $this->__('Start date') => 'startDate',
                    $this->__('End date') => 'endDate',
                    $this->__('Sponsoring user') => 'sponsoringUser',
    ...
    {
        return 'rksponsoringmodule_sponsorquicknav';
    }
}
