...
namespace RK\SponsoringModule\Form\DataTransformer\Base;
...
use RK\SponsoringModule\Form\Type\Field\UploadType;
use RK\SponsoringModule\Helper\ControllerHelper;
use RK\SponsoringModule\UploadHandler;
...
abstract class AbstractUploadFileTransformer implements DataTransformerInterface
{
    ...
    public function __construct(UploadType $formType, $fieldName)
    {
        ...
        $this->controllerHelper = ServiceUtil::get('rk_sponsoring_module.controller_helper');
        $this->uploadHandler = ServiceUtil::get('rk_sponsoring_module.upload_handler');
    ...
    public function reverseTransform($data)
    {
        ...
        if (null === $uploadedFile) {
            // check files array
            $filesKey = 'rksponsoringmodule_' . $objectType;
