...
namespace RK\SponsoringModule\Twig\Base;
...
use RK\SponsoringModule\Helper\ViewHelper;
...
abstract class AbstractTwigExtension extends \Twig_Extension
{
    ...
    {
        return [
            new \Twig_SimpleFunction('rksponsoringmodule_objectTypeSelector', [$this, 'getObjectTypeSelector']),
            new \Twig_SimpleFunction('rksponsoringmodule_templateSelector', [$this, 'getTemplateSelector']),
            new \Twig_SimpleFunction('rksponsoringmodule_userVar', [$this, 'getUserVar']),
            new \Twig_SimpleFunction('rksponsoringmodule_userAvatar', [$this, 'getUserAvatar'], ['is_safe' => ['html']])
        ];
    }
    ...
    {
        return [
            new \Twig_SimpleFilter('rksponsoringmodule_fileSize', [$this, 'getFileSize'], ['is_safe' => ['html']]),
            new \Twig_SimpleFilter('rksponsoringmodule_listEntry', [$this, 'getListEntry']),
            new \Twig_SimpleFilter('rksponsoringmodule_objectState', [$this, 'getObjectState'], ['is_safe' => ['html']])
        ];
    }
    
    /**
     * The rksponsoringmodule_objectState filter displays the name of a given object's workflow state.
     * Examples:
     *    {{ item.workflowState|rksponsoringmodule_objectState }}        {# with visual feedback #}
     *    {{ item.workflowState|rksponsoringmodule_objectState(false) }} {# no ui feedback #}
     *
    ...
    /**
     * The rksponsoringmodule_fileSize filter displays the size of a given file in a readable way.
     * Example:
     *     {{ 12345|rksponsoringmodule_fileSize }}
     *
    ...
    /**
     * The rksponsoringmodule_listEntry filter displays the name
     * or names for a given list item.
     * Example:
     *     {{ entity.listField|rksponsoringmodule_listEntry('entityName', 'fieldName') }}
     *
    ...
    /**
     * The rksponsoringmodule_objectTypeSelector function provides items for a dropdown selector.
     *
    ...
    /**
     * The rksponsoringmodule_templateSelector function provides items for a dropdown selector.
     *
     * @return string The output of the plugin
     */
    ...
    public function getUserAvatar($uid, $width = 0, $height = 0, $size = 0, $rating = '')
    {
        ...
        $view = \Zikula_View::getInstance('RKSponsoringModule');
