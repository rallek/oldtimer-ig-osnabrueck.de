...
namespace RK\SponsoringModule\Menu\Base;
...
class AbstractItemActionsMenu implements ContainerAwareInterface
{
    ...
    public function menu(FactoryInterface $factory, array $options)
    {
        ...
        if ($entity instanceof SponsorEntity) {
            $component = 'RKSponsoringModule:Sponsor:';
            $instance = $entity['id'] . '::';
        
        if ($currentLegacyControllerType == 'admin') {
            if (in_array($currentFunc, ['index', 'view'])) {
                $menu->addChild($this->__('Preview'), [
                    'route' => 'rksponsoringmodule_sponsor_display',
                ...
                $menu->addChild($this->__('Details'), [
                    'route' => 'rksponsoringmodule_sponsor_admindisplay',
                    'routeParameters' => ['id' => $entity['id']]
            ...
            if (in_array($currentFunc, ['index', 'view', 'display'])) {
                if ($permissionApi->hasPermission($component, $instance, ACCESS_EDIT)) {
                    $menu->addChild($this->__('Edit'), [
                        'route' => 'rksponsoringmodule_sponsor_adminedit',
                        'routeParameters' => ['id' => $entity['id']]
                    ])->setAttribute('icon', 'fa fa-pencil-square-o');
                    $menu[$this->__('Edit')]->setLinkAttribute('title', $this->__('Edit this sponsor'));
                    $menu->addChild($this->__('Reuse'), [
                        'route' => 'rksponsoringmodule_sponsor_adminedit',
                        'routeParameters' => ['astemplate' => $entity['id']]
                    ])->setAttribute('icon', 'fa fa-files-o');
                    $menu[$this->__('Reuse')]->setLinkAttribute('title', $this->__('Reuse for new sponsor'));
                }
                if ($permissionApi->hasPermission($component, $instance, ACCESS_DELETE)) {
                    $menu->addChild($this->__('Delete'), [
                        'route' => 'rksponsoringmodule_sponsor_admindelete',
                        'routeParameters' => ['id' => $entity['id']]
                    ])->setAttribute('icon', 'fa fa-trash-o');
                    $menu[$this->__('Delete')]->setLinkAttribute('title', $this->__('Delete this sponsor'));
                }
            }
            if ($currentFunc == 'display') {
                $title = $this->__('Back to overview');
                $menu->addChild($title, [
                    'route' => 'rksponsoringmodule_sponsor_adminview'
        ...
        if ($currentLegacyControllerType == 'user') {
            ...
            if (in_array($currentFunc, ['index', 'view', 'display'])) {
                if ($permissionApi->hasPermission($component, $instance, ACCESS_EDIT)) {
                    $menu->addChild($this->__('Edit'), [
                        'route' => 'rksponsoringmodule_sponsor_edit',
                        'routeParameters' => ['id' => $entity['id']]
                    ])->setAttribute('icon', 'fa fa-pencil-square-o');
                    $menu[$this->__('Edit')]->setLinkAttribute('title', $this->__('Edit this sponsor'));
                    $menu->addChild($this->__('Reuse'), [
                ...
                if ($permissionApi->hasPermission($component, $instance, ACCESS_DELETE)) {
                    $menu->addChild($this->__('Delete'), [
                        'route' => 'rksponsoringmodule_sponsor_delete',
                        'routeParameters' => ['id' => $entity['id']]
                    ])->setAttribute('icon', 'fa fa-trash-o');
                    $menu[$this->__('Delete')]->setLinkAttribute('title', $this->__('Delete this sponsor'));
                }
            ...
            if ($currentFunc == 'display') {
                $title = $this->__('Back to overview');
                $menu->addChild($title, [
                    'route' => 'rksponsoringmodule_sponsor_view'
                ])->setAttribute('icon', 'fa fa-reply');
                $menu[$title]->setLinkAttribute('title', $title);
            }
        }
