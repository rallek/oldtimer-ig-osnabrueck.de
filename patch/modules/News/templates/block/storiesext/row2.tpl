...
<div class="section">
	<div class="storiesext">		
		<div class="container">
			<div class="row">
				<div class="col-md-6 col-sm-6 col-xs-4 bottom-space top-space">
					{if $modvars.News.picupload_enabled AND $pictures gt 0}
						...
						{else}
							<a href="{modurl modname='News' type='user' func='display' sid=$sid}"><img class="top-space" src="{$modvars.News.picupload_uploaddir}/pic_sid{$sid}-0-norm.jpg" width="100%" alt="{gt text='Picture %1$s for %2$s' tag1='0' tag2=$title}" /></a>
						{/if}
					{/if}
				</div>
